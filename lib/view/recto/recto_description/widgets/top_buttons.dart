      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            color: getBgSwitchColor(context, ref, widget.isMobile, mode,
                swapColors: widget.isMobile && widget.verso),
          ),
          child: Icon(
...
Color? getBgSwitchColor(
    BuildContext context, WidgetRef ref, bool isMobile, ModeSwitcher mode,
